"""
Django settings for shop_nest project.
...
SECRET_KEY = 'django-insecure-jiyj5@dem$j$^h%i5uli*g9%+-+5qnb3j8nq96pcp(yf&%-79g'
...
WSGI_APPLICATION = 'shop_nest.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': SECRET_KEY,  # Key to sign the JWT, typically your Django SECRET_KEY
